...
export function MapView({
  ...
  if (validSectors.length === 0) {
    return (
      <div className="sticky top-0 z-10 h-[25vh] min-h-[180px] max-h-[35vh] rounded-lg overflow-hidden border border-border bg-muted flex items-center justify-center">
  ...
  return (
    <div className="sticky top-0 z-10 h-[30vh] min-h-[200px] max-h-[35vh] rounded-lg overflow-hidden border border-border shadow-lg">
      <MapContainer
        center={center}
        zoom={zoom}
